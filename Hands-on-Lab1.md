...
1. ADFRuntime-nsg の概要で、初期 NSG の構成が以下となっている事が確認できます。受信セキュリティでは仮想マシンの RDP 接続以外はインターネットからの着信は許可されていません。他方、送信セキュリティではインターネットへの送信が許可されています。
...
4. サービスタグを利用して、Azure Storage 東南アジア
